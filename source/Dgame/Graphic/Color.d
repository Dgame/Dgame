...
static struct Colors(T) {
    static immutable T Black   = T(0,     0,   0); /// Black Color (0, 0, 0)
    static immutable T White   = T(255, 255, 255); /// White Color (255, 255, 255)
    static immutable T Red     = T(255,   0,   0); /// Red Color (255, 0, 0)
    static immutable T Green   = T(0,   255,   0); /// Green Color (0, 255, 0)
    static immutable T Blue    = T(0,     0, 255); /// Blue Color (0, 0, 255)
    static immutable T Cyan    = T(0,   255, 255); /// Cyan Color (0, 255, 255)
    static immutable T Yellow  = T(255, 255,   0); /// Yellow Color (255, 255, 0)
    static immutable T Magenta = T(255,   0, 255); /// Magenta Color (255, 0, 255)
    static immutable T Gray    = T(179, 179, 179); /// Gray Color (179, 179, 179)
}
